...
- [k3s-io/kine](https://github.com/k3s-io/kine) - Run Kubernetes on MySQL, Postgres, sqlite, dqlite, not etcd. (3 days ago)
- [Permify/permify](https://github.com/Permify/permify) - Permify is an open-source authorization service inspired by Google Zanzibar. (3 days ago)
- [vescale/zgraph](https://github.com/vescale/zgraph) - An embeddable graph database for large-scale vertices and edges (3 days ago)
...
- [cnrv/riscv-innovations](https://github.com/cnrv/riscv-innovations) - RISC-V is where innovation happens! (5 days ago)
