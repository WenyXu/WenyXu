...
- [containerd/ttrpc](https://github.com/containerd/ttrpc) - GRPC for low-memory environments (2 days ago)
- [sparsemat/sprs](https://github.com/sparsemat/sprs) - sparse linear algebra library for rust (2 days ago)
