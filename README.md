...
- [feat: add close method for the region trait](https://github.com/GreptimeTeam/greptimedb/pull/970) on [GreptimeTeam/greptimedb](https://github.com/GreptimeTeam/greptimedb) (2 days ago)
...
- [Xuanwo/backon](https://github.com/Xuanwo/backon) - Retry with backoff without effort. (2 days ago)
- [datafuselabs/summer-of-code](https://github.com/datafuselabs/summer-of-code) - Summer of Code with Datafuse Labs (4 days ago)
- [v6d-io/v6d](https://github.com/v6d-io/v6d) - vineyard (v6d): an in-memory immutable data manager. (Project under CNCF, TAG-Storage) (4 days ago)
- [eto-ai/lance](https://github.com/eto-ai/lance) - Alternative to Parquet. 100x faster for random access, includes a vector index and automatic versioning. Apache Arrow and DuckDB compatible. (4 days ago)
- [lizhuohua/linux-kernel-module-rust](https://github.com/lizhuohua/linux-kernel-module-rust) -  (5 days ago)
- [lencx/ChatGPT](https://github.com/lencx/ChatGPT) - 🔮 ChatGPT Desktop Application (Mac, Windows and Linux) (5 days ago)
- [duo-labs/webauthn](https://github.com/duo-labs/webauthn) - WebAuthn (FIDO2) server library written in Go  (5 days ago)
- [luispedro/diskhash](https://github.com/luispedro/diskhash) - Diskbased (persistent) hashtable (5 days ago)
- [risinglightdb/sql-optimizer-labs](https://github.com/risinglightdb/sql-optimizer-labs) - 🚧 Build a SQL optimizer in 1000 lines of Rust using egg. (5 days ago)
- [egraphs-good/egg](https://github.com/egraphs-good/egg) - egg is a flexible, high-performance e-graph library (5 days ago)
- [spf13/afero](https://github.com/spf13/afero) - A FileSystem Abstraction System for Go (6 days ago)
- [avfs/avfs](https://github.com/avfs/avfs) - Another Virtual File System for Go (6 days ago)
- [Property404/its-a-unix-system](https://github.com/Property404/its-a-unix-system) - Web-based terminal (6 days ago)
- [buraksezer/olric](https://github.com/buraksezer/olric) - Distributed in-memory object store. It can be used both as an embedded Go library and as a language-independent service. (6 days ago)
